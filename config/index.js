export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wx0481416ec2fed493",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "b7278d0f85fc8b133255e9a61faccd51",
   ...
   * ]
   */
  USERS: [oi3t76Or26Rw5NnjB-Edi1td3vwM
    {
      // 想要发送的人的名字
      name: "宝贝",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
    ...
    {
      name: "老婆1", 
      id: "oi3t76O-Ek3Xb_ZlYPXcl2jK694I",
      useTemplateId: "Wue80GrtY1nAi5a4tam4FDxZF59WNx9pwcBc06LMpANnu8",
      province: "浙江",
      city: "丽水",
      openUrl: "https://wangxinleo.cn"
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ooi3t76O-Ek3Xb_ZlYPXcl2jK694I",
    }, 
  ],
   ...
   */
  FESTIVALS: [
    {"type": "生日", "name": "老婆", "year": "2004", "date": "05-07"},
  ],
  ...
  CUSTOMIZED_DATE_LIST: [
    // 在一起的日子
    {"keyword": "love_day", date: "2018-07-03"},
  ],
